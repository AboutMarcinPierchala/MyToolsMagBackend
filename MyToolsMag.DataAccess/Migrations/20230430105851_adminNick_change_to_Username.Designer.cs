...
namespace MyToolsMag.DataAccess.Migrations
{
    ...
    [Migration("20230430105851_adminNick_change_to_Username")]
    partial class adminNick_change_to_Username
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyToolsMag.DataAccess.Entities.Tool", b =>
                {
                    b.HasOne("MyToolsMag.DataAccess.Entities.Person", "Person")
                        .WithMany("Tools")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyToolsMag.DataAccess.Entities.Place", "Place")
                        .WithMany()
                        .HasForeignKey("PlaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyToolsMag.DataAccess.Entities.ToolCategory", "ToolCategory")
                        .WithMany("Tools")
